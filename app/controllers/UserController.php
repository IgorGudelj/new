...
use Zavrsni\Repo\Group\GroupInterface;
...
class UserController extends BaseController {
		...
		SuspendUserForm $suspendUserForm)
	{
		...
		$this->beforeFilter('inGroup:Administrator', array('only' => array('show', 'index', 'destroy', 'suspend', 'unsuspend', 'ban', 'unban', 'edit', 'update')));
	}
	...
	public function edit($id)
	{
        ...
        return View::make('users.edit')->with('user', $user)->with('userGroups', $userGroups)->with('allGroups', $allGroups)->with('places', $places);
	}
