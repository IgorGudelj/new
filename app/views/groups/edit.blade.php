...
<div class="row">
	...
	{{ Form::open(array('action' =>  array('GroupController@update', $group->id), 'method' => 'put')) }}
        ...
        <?php 
            ...
            if (!array_key_exists('user', $permissions)) $permissions['user'] = 0;
        ?>
        
        <div class="form-group">
            <label class="checkbox-inline">
                {{ Form::checkbox('adminPermissions', 1, $permissions['admin'] ) }} Administrator
            </label>
            <label class="checkbox-inline">
                {{ Form::checkbox('userPermissions', 1, $permissions['user'] ) }} User
            </label>
        </div>
