...
<div class="row">
    <div class="col-md-4 col-md-offset-4">
        {{ Form::model($listing, array('action' => 'ListingsController@store')) }}

            <h2>{{trans('listings.edit')}}</h2>
            ...
            <div class="form-group {{ ($errors->has('place_id')) ? 'has-error' : '' }}" for="place_id">
                ...
                <div class="col-sm-10">
                  {{ Form::select('place_id', [null => trans('users.placeSelect')] + $places, $listing->place_id, array('id' => 'place_id', 'onchange'=>'codeAddress()'))}}
                </div>
            ...
            {{ Form::submit(trans('listings.edit'), array('class' => 'btn btn-primary')) }}
